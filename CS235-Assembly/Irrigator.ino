...
#define AP_SSID     "kriazwifi" //HarisWifi //NUST //muneeb //HUAWEI_P9lite_DB64
#define AP_PASSWORD "faebdc3421" //dcwp0557 //nust008tech //muneeb12

#define EIOTCLOUD_USERNAME "harisriaz17"
#define EIOTCLOUD_PASSWORD "iotproject"
...
#define PIN_BUTTON       D3  // nodemcu flash button for flashing the processor to set a new threshold value
...
#define IRRIGATION_PAUSE_TIME  20 // irrigation pause time in sec - only for auto irrigator
...
struct StoreStruct {
  // This is for mere detection if they are your settings i.e it is used to create a module in the cloud with some defined properties
  char version[4];
  // The variables of our settings
  uint moduleId;  // module id
} storage = {
  CONFIG_VERSION,
  // The default module is 0
  0,
};
